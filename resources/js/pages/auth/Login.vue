  ...
  <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }"
    ...
    <div class="grid gap-6">
      <div class="grid gap-2">
        ...
        <InputError class="text-(--destructive) bg-(--destructive-foreground)" :message="errors.email" />
      </div>
      ...
      <div class="grid gap-2">
        ...
        <InputError class="text-(--destructive) bg-(--destructive-foreground)" :message="errors.password" />
      </div>

      <div class="flex items-center justify-between">
        <Label for="remember" class="cursor-pointer flex items-center space-x-3">
